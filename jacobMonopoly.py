def monop(finish_order, games_order):
    ...
    rollvalues = [2, 3, 4, 5, 6, 7, 3, 4, 5, 6, 7, 8, 4, 5, 6, 7, 8, 9, 5, 6, 7, 8, 9, 10, 6, 7, 8, 9, 10, 11, 7, 8, 9,
                  10, 11, 12]
    ...
    return squares  # array of squares


if __name__ == '__main__':
    kob: int = 0
    while kob < 10:
        # call monop function and assign to var
        var = monop(1000000, 1)
        print(var)
        # print out percentage of landing on each individual square
        percents = []
        j = 0
        for i in var:
            percents.append(var[j] / sum(var))
